...
for x,k1,k2,l,c,mrk,ms,ls in zip([R_list,R_list],
    ...
    #ax5.plot( [0,10], np.ones(2)*kcal*(y2-y0), c='blue', ls='--', linewidth=0.5)   
    #ax6.plot( [0,10], np.ones(2)*kcal*(y3-y1), c='green', ls='--', linewidth=0.5)
    
    
#ax5.annotate(str(round(fline[0],2)) + ' kcal/mol', xy=(0,fline[0]+0.3), fontsize=10, color='black')
#ax5.annotate(str(round(fline[1],2)) + ' kcal/mol', xy=(7.5,fline[1]+0.3), fontsize=10, color='black')
#ax6.annotate(str(round(nline[0],2)) + ' kcal/mol', xy=(0,nline[0]+0.3), fontsize=10, color='black')
#ax6.annotate(str(round(nline[1],2)) + ' kcal/mol', xy=(7.5,nline[1]+0.3), fontsize=10, color='black')
...
fill_panel(ax1,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{anion}} \, [E_h] (1s)$', [-75.65,-75.45],[-75.65,-75.60,-75.55,-75.50,-75.45], ['-75.65','-75.60','-75.55','-75.50','-75.45']) 
fill_panel(ax2,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{anion}} \, [E_h] (1s2s)$',[-75.65,-75.45],[-75.65,-75.60,-75.55,-75.50,-75.45], ['-75.65','-75.60','-75.55','-75.50','-75.45']) 
fill_panel(ax3,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{radical}} \, [E_h] (1s)$',[-75.65,-75.45],[-75.65,-75.60,-75.55,-75.50,-75.45], ['-75.65','-75.60','-75.55','-75.50','-75.45']) 
fill_panel(ax4,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{radical}} \, [E_h] (1s2s)$',[-75.65,-75.45],[-75.65,-75.60,-75.55,-75.50,-75.45], ['-75.65','-75.60','-75.55','-75.50','-75.45']) 
...
fig.savefig('freezing_qz.pdf',format='pdf',bbox_inches='tight')
