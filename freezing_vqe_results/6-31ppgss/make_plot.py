...
fill_panel(ax1,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{anion}} \, [E_h] (1s)$', [-75.55,-75.35],[-75.55,-75.50,-75.45,-75.40,-75.35], ['-75.55','-75.50','-75.45','-75.40','-75.35']) 
fill_panel(ax2,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{anion}} \, [E_h] (1s2s)$',[-75.55,-75.35],[-75.55,-75.50,-75.45,-75.40,-75.35], ['-75.55','-75.50','-75.45','-75.40','-75.35'])
fill_panel(ax3,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{radical}} \, [E_h] (1s)$',[-75.55,-75.35],[-75.55,-75.50,-75.45,-75.40,-75.35], ['-75.55','-75.50','-75.45','-75.40','-75.35']) 
fill_panel(ax4,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{radical}} \, [E_h] (1s2s)$',[-75.55,-75.35],[-75.55,-75.50,-75.45,-75.40,-75.35], ['-75.55','-75.50','-75.45','-75.40','-75.35']) 
