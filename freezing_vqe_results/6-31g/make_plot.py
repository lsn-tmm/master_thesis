...
fill_panel(ax1,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{anion}} \, [E_h] (1s)$', [-75.43,-75.27],[-75.43,-75.39,-75.35,-75.31,-75.27],
                                                  ['-75.43','-75.39','-75.35','-75.31','-75.27'])
fill_panel(ax2,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{anion}} \, [E_h] (1s2s)$',[-75.43,-75.27],[-75.43,-75.39,-75.35,-75.31,-75.27],
                                                  ['-75.43','-75.39','-75.35','-75.31','-75.27'])
fill_panel(ax3,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{radical}} \, [E_h] (1s)$',[-75.43,-75.27],[-75.43,-75.39,-75.35,-75.31,-75.27],
                                                  ['-75.43','-75.39','-75.35','-75.31','-75.27'])
fill_panel(ax4,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{radical}} \, [E_h] (1s2s)$',[-75.43,-75.27],[-75.43,-75.39,-75.35,-75.31,-75.27],
                                                  ['-75.43','-75.39','-75.35','-75.31','-75.27'])

fill_panel(ax5,'',[0,10],[3,7],['NEVPT2($R_y$,QSE)','NEVPT2(q-UCCSD,QSE)'],
                  '$E_{\mathrm{radical}}(1s)-E_{\mathrm{anion}}(1s)$ [kcal/mol]',[-30,20],[-30,-20,-10,0,10,20],[-30,-20,-10,0,10,20])
fill_panel(ax6,'',[0,10],[3,7],['NEVPT2($R_y$,QSE)','NEVPT2(q-UCCSD,QSE)'],
                  '$E_{\mathrm{radical}}(1s2s)-E_{\mathrm{anion}}(1s2s)$ [kcal/mol]',[-30,20],[-30,-20,-10,0,10,20],[-30,-20,-10,0,10,20])
