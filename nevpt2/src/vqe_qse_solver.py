...
from qiskit_subroutines import prepare_operators,run_vqe,measure_operators

class VQE_QSE_solver(NEVPT2_solver):

      def set_quantum_variables(self,quantum_variables):
          self.quantum_variables = quantum_variables

      def compute_ground_state(self):
          SOLVER = BO_solver(self.BO_IAO)
          print(" >>>>> AM I PREPARED? ",self.prepared)
