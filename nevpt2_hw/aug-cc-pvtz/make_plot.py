...
colors = [ [c_list['red'],c_list['orange'],c_list['light_yellow']],[c_list['dark_blue'],c_list['cobalt'],c_list['cerulean']] ]
...
fill_panel(ax1,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{anion}} \, [E_h]$',[-75.58,-75.46],[-75.58,-75.55,-75.52,-75.49,-75.46],
                                                  ['-75.58','-75.55','-75.52','-75.49','-75.46'])
fill_panel(ax4,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{anion}} - E_{\mathrm{statevector}} \, [E_h]$',[0.00,0.02],[0.000,0.005,0.010,0.015,0.020],
                                                  ['0.000','0.005','0.010','0.015','0.020'])
                                                  
fill_panel(ax2,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{radical}} \, [E_h]$',[-75.58,-75.46],[-75.58,-75.55,-75.52,-75.49,-75.46],
                                                  ['-75.58','-75.55','-75.52','-75.49','-75.46'])

fill_panel(ax5,'$R_{\mathrm{OH}} \, [\mathrm{\AA}]$',[0.8,1.2],[0.8,0.9,1.0,1.1,1.2],['0.8','0.9','1.0','1.1','1.2'],
               '$E_{\mathrm{radical}} - E_{\mathrm{statevector}} \, [E_h]$',[0.00,0.02],[0.000,0.005,0.010,0.015,0.020],
                                                  ['0.000','0.005','0.010','0.015','0.020'])

fill_panel(ax3,'',[0,7],[1,2,3,4,5,6],['qasm RAW','qasm EM','qasm EM+RE','manila RAW','manila EM','manila EM+RE'],
                  '$E_{\mathrm{radical}}-E_{\mathrm{anion}}$ [kcal/mol]',[25,40],[25,28,31,34,37,40],[25,28,31,34,37,40])
fill_panel(ax6,'',[0,7],[1,2,3,4,5,6],['qasm RAW','qasm EM','qasm EM+RE','manila RAW','manila EM','manila EM+RE'],
                  '$\Delta E-E_{\mathrm{statevector}}$ [kcal/mol]',[-8,2],[-8,-6,-4,-2,0,2],[-8,-6,-4,-2,0,2])
...
fig.savefig('prova2.pdf',format='pdf',bbox_inches='tight')
