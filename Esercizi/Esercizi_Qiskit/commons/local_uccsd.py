...
class UCCSD(VariationalForm):
    ...
    def _build_hopping_operator(index, num_orbitals, num_particles, qubit_mapping,
                                ...
                                skip_commute_test=False, _target_sector = None):
        """
        ...
        if not z2_symmetries.is_empty():
            ...
            if not skip_commute_test:
                qubit_op = z2_symmetries.taper(qubit_op)[_target_sector] if symm_commuting else None
            else:
                qubit_op = z2_symmetries.taper(qubit_op)[_target_sector] 
