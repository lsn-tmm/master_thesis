...
hardware = ['manila','lima','quito','santiago','belem','bogota']
...
for (x,y),k in zip([(0,0),(0,1),(1,0),(1,1)],A.keys()):
    ...
    data_em    = ((s2[:,0]-a[:,0]) + (l2[:,0]-a[:,0]) + (q2[:,0]-a[:,0]) + (m2[:,0] - a[:,0]) + (b2[:,0]-a[:,0]) + (t2[:,0]-a[:,0]))/6
    manila     = m2[:,0]-a[:,0]
    santiago   = s2[:,0]-a[:,0]
    lima       = l2[:,0]-a[:,0]
    quito      = q2[:,0]-a[:,0]
...
for (x,y),k in zip([(0,0),(0,1),(1,0),(1,1)],A.keys()):
    ...
    data_em_re = ((s3[:,0]-a[:,0]) + (l3[:,0]-a[:,0]) + (q3[:,0]-a[:,0]) + (m3[:,0]-a[:,0]) + (b3[:,0]-a[:,0]) + (t3[:,0]-a[:,0]))/6
    manila     = m3[:,0]-a[:,0]
    santiago   = s3[:,0]-a[:,0]
    lima       = l3[:,0]-a[:,0]
    quito      = q3[:,0]-a[:,0]
