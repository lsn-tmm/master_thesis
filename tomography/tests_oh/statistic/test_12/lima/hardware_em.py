...
if(task=='submit'):
   T.submit_probability_distribution_jobs(circuits_per_job=max_circuits_per_job,logfile_name='logfile_lima_em.txt')
elif(task=='retrieve'):
   jobs = [f.split()[2] for f in open('logfile_lima_em.txt','r').readlines()]
