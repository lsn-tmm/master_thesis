...
#bloch_1 = np.load(dir+'_nm_em_bloch.npy',allow_pickle=True).item()
#bloch_3 = np.load(dir+'_nm_em_re_bloch.npy',allow_pickle=True).item()
#bloch_r = {k:ric(bloch_1[k],bloch_3[k]) for k in bloch_1.keys()}
np.save(dir+'_nm_em_re_extrapolated_bloch.npy',bloch_r,allow_pickle=True)
